        ...
        <?php echo $this->BSForm->create($modelClass); ?>
			<fieldset>
				...
				<div class="control-group">
					<label for="ArticleArticleTitle">标题</label><input
						name="data[Article][articleTitle]" required="required"
						maxlength="255" type="text" id="ArticleArticleTitle" />
				</div>
				<?php echo $this->BSForm->input("Article.articleTypeId", array('created', 'modified', 'updated')); ?>
				<div class="control-group">
					<label for="ArticleArticleContent">正文</label>
					<textarea name="data[Article][articleContent]" class="ckeditor"
						required="required" cols="30" rows="6" id="ArticleArticleContent"></textarea>
				</div>
				<div class="control-group">
					<label for="ArticleArticleTags">标签</label>
					<input name="data[Article][articleTags]" required="required" cols="30" rows="6" id="ArticleArticleTags" />
				</div>
			</fieldset>  
