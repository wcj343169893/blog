...
<html>
    <head>
        ...
        <script src="//file2.mofing.com/js/jquery-1.8.2.min.js"></script>        
        ...
        <!--[if lt IE 9]>
            <script src="file2.mofing.com/js/html5.js"></script>
        <![endif]-->
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                ...
                <?php // debug($this); ?>
                <p style="text-align:center;">Powered by: <a href="#">cj</a></p>
            </div>
        </div>
    </body>
</html>
